			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="dataInformada" title="${message(code: 'pedido.dataInformada.label', default: 'Data Informada')}" />
					
						<g:sortableColumn property="dataReal" title="${message(code: 'pedido.dataReal.label', default: 'Data Real')}" />
				...
				<g:each in="${pedidoInstanceList}" status="i" var="pedidoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${pedidoInstance.dataInformada}" /></td>
					
						<td><g:formatDate date="${pedidoInstance.dataReal}" /></td>
