...
<div class="fieldcontain ${hasErrors(bean: usuarioInstance, field: 'firstName', 'error')} ">
	<label for="firstName">
		<g:message code="usuario.firstName.label" default="First Name" />
		
	</label>
	<g:textField name="firstName" maxlength="30" value="${usuarioInstance?.firstName}"/>
</div>

<div class="fieldcontain ${hasErrors(bean: usuarioInstance, field: 'lastName', 'error')} ">
	<label for="lastName">
		<g:message code="usuario.lastName.label" default="Last Name" />
		
	</label>
	<g:textField name="lastName" maxlength="30" value="${usuarioInstance?.lastName}"/>
</div>
